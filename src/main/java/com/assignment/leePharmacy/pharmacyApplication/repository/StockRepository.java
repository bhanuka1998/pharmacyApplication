...
public interface StockRepository extends CrudRepository<Stock, Integer> {
    @Query(value = "SELECT new com.assignment.leePharmacy.pharmacyApplication.dto.StockDrugDTO(s.stockID, d.drugID, d.drugName, s.mfDate, s.expDate, s.qty, s.rcvdDate) FROM Stock s" +
